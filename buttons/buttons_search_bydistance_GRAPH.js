...
try {window.DefinePanel('Search by Distance Buttons', {author:'xxx'});} catch (e) {/* console.log('Search by Distance (GRAPH) Buttons loaded.'); */} //May be loaded along other buttons
...
addButton({
    'Search by Distance (G) nearest tracks': new themedButton({x: 0, y: 0, w: 106, h: 22}, 'Nearest Tracks', function () {
		let t0 = Date.now();
		let t1 = 0;
