...
try {window.DefinePanel('Playlist Tools: Buttons Bar', {author:'XXX', version: '3.0.0-beta.16', features: {drag_n_drop: false}});} catch (e) {} //May be loaded along other buttons
