...
## Installation
See [Wiki](https://github.com/regorxxx/Search-by-Distance-SMP/wiki/Installation) or the [_INSTALLATION (txt)](https://github.com/regorxxx/Search-by-Distance-SMP/blob/main/_INSTALLATION.txt).
