...
const music_graph_descriptors_culture =  new regionMap ({
	...
	culturalRegion: {
		...
		'Asia': {
			...
			'East Asia': [
				'Japanese Classical_supergenre','Japanese Prog. Rock','Japanese','Minimal Wave','New Age','Nu Jazz','Future Jazz','Ambient House','Glam Metal','Hair Metal','Pop Metal','Eclectic Prog','Math Rock','Garage Punk','Garage Rock','Electrofunk','Ambient Folk','Trancecore','Speedcore','Glitch','Bit Music','Ambient'
			],
			'South Asia': [
		...
		'Europe': {
			...
			'Southern Europe': [
				'South European Folk_supergenre','Flamenco Rock','Italian Prog. Rock','Spanish Rock','Spanish Jazz','Spanish Hip-Hop','Italian Rock','Greek','Italian Prog. Rock','Nuevo Flamenco','Ibiza House','Italo Disco','Dream House','Tech House','Gypsy-Jazz','Symphonic Rock','Trap','Alt. Rap','Underground Rap','Hardcore Punk','Garage Rock','Disco','Mainstream Hardcore','Hardstyle','Ibiza Trance','Dream Trance'
			],
			'Central Europe': [
