...
const music_graph_descriptors_culture = new RegionMap({
	...
	culturalRegion: {
		...
		'Europe': {
			...
			'Southern Europe': [
				'South European Folk_supergenre', 'Flamenco Rock', 'Italian Prog. Rock', 'Spanish Rock', 'Spanish Jazz', 'Spanish Hip-Hop', 'Italian Rock', 'Greek', 'Italian Prog. Rock', 'Nuevo Flamenco', 'Ibiza House', 'Italo Disco', 'Dream House', 'Tech House', 'Gypsy-Jazz', 'Symphonic Rock', 'Trap', 'Alt. Rap', 'Underground Rap', 'Hardcore Punk', 'Garage Rock', 'Disco', 'Mainstream Hardcore', 'Hardstyle', 'Ibiza Trance', 'Dream Trance','Murga'
			],
			'Central Europe': [
			...
			'Northern Europe': [
				'Nordic Folk_supergenre', 'Yoik', 'Luohti', 'Vuolle', 'Juoiggus', 'Celtic-Nordic Folk XL', 'Nordic Jazz', 'Pagan Folk', 'Symphonic Metal', 'Atmospheric Black Metal', 'Black Metal', 'Glam Metal', 'Hair Metal', 'Pop Metal', 'Progressive Metal', 'Hardcore Punk', 'Neo Trance'
			]
		},
		'Mashriq': { // West Asia
			'_ALL_': [
		...
		'America': {
			...
			'South America': [
				'South American Folk_supergenre', 'Latin Rock XL', 'Latin Folk XL', 'Argentinian Rock', 'Uruguayan Rock', 'Música Popular Brasileira', 'Latin-Jazz', 'Bossa Nova', 'Nu Jazz', 'Future Jazz', 'Deep House', 'Thrash Metal', 'Power Metal', 'Alt. Rap', 'Underground Rap', 'Hardcore Punk', 'Garage Rock', 'Melodic Techno-House','Murga'
			]
		},
		'Oceania': {
			'_ALL_': [
