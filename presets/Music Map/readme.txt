...
'Music Map' buttons and tools instead of evaluating with a selected
track.

Recipes are 'variables containers' which emulate the input of
'Music Map' buttons and tools instead of using hardcoded variables
...
Currently used on the customizable 'Music Map' button.